...
const About = () => {
  return (
    <div>
      <h1 className='text-2xl font-mono mb-4 text-center md:text-5xl font-bold md:my-5'>About</h1>
      <div className='md:grid md:grid-cols-2 md:justify-evenly md:gap-10'>
      <div className='flex justify-center'>
        <img src={aboutImage} alt="about-image" className='w-5/6 md:h-96 object-cover md:w-full' />
      </div>
