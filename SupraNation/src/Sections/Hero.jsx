...
const Hero = () => {
  return (
    <>
      <div>
        <div>
          <video src={videoBg} filter autoPlay loop className='h-96 object-cover w-full brightness-50 md:w-full md:h-full md:object-cover md:brightness-50 lg:object-cover lg:brightness-50'></video>
